...
function changeTheme(e) {
  if (isLightMode) {
    ...
    document.querySelector('#tsparticles-light').style.display = 'block';
    document.querySelector('#tsparticles-dark').style.display = 'none';
    isLightMode = false;
  } else {
    sunMoonIMG.src = 'assets/sun.png';
    body.classList.add('dark-theme');
    document.querySelector('#tsparticles-light').style.display = 'none';
    document.querySelector('#tsparticles-dark').style.display = 'block';
    isLightMode = true;
  }
}
...
tsParticles.load('tsparticles-light', options);
options.particles.number.limit = 10;
options.particles.move.speed = 1;
tsParticles.load('tsparticles-dark', options);
document.querySelector('#tsparticles-dark').style.display = 'none';
